...
class MapManager {
    ...
    createMarkerIcon(incident) {
        const isDark = document.documentElement.classList.contains('dark');
        const type = incident.incidentType?.toLowerCase() || 'other';
        const colors = {
            'physical violence': isDark ? '#EF4444' : '#DC2626',
            'verbal abuse': isDark ? '#F59E0B' : '#D97706', 
            'discrimination': isDark ? '#8B5CF6' : '#7C3AED',
            'property damage': isDark ? '#F97316' : '#EA580C',
            'social boycott': isDark ? '#EC4899' : '#DB2777',
        ...
        return `
            ...
            ">
                <h3 style="
                    ...
                    margin: 0 0 0.5rem 0;
                    color: ${textColor};
                ">${incident.headline || 'Untitled Incident'}</h3>
                ...
                ">
                    <p style="margin: 0.25rem 0;">
                        <strong>Date:</strong> ${new Date(incident.incidentDate || incident.publishedAt).toLocaleDateString()}
                    </p>
                    <p style="margin: 0.25rem 0;">
                        <strong>Location:</strong> ${incident.district || 'Unknown'}, ${incident.state || 'Unknown'}
                    </p>
                    <p style="margin: 0.25rem 0;">
                        <strong>Type:</strong> ${incident.incidentType || 'Unknown'}
                    </p>
                    <p style="margin: 0.25rem 0;">
                        <strong>Victim Group:</strong> ${incident.victimGroup || 'Unknown'}
                    </p>
                </div>
